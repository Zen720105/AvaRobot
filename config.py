...
class Config(object):
    ...
    TOKEN = getenv("TOKEN")
    OWNER_ID = int(getenv("OWNER_ID", 7378877654))
    OWNER_USERNAME = getenv("OWNER_USERNAME", "ll_ITS_MEHH_DEMON_ll")
    SUPPORT_CHAT = getenv("SUPPORT_CHAT", "NIYTODUPORRTCHATT")
    LOGGER_ID = int(getenv("LOGGER_ID", "-1002344655737"))
